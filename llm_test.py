...
with open("results/inference_results.jsonl", "a") as f:
    json.dump({"prompt": prompt, "response": output_text}, f, ensure_ascii=False)
    f.write("\n")

print("Saved full result to results/inference_results.jsonl")